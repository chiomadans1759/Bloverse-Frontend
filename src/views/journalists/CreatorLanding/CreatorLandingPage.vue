<template>
  <main id="bl-creators" class="container-fluid p-0">
    ...
    <div class="top-section-container">
      ...
      <div class="container">
          ...
          <div class="welcome__link">
            <h1 class="title">Interactive stories from <br>the global community</h1>
            <p class="paragraph">Connecting creators to the people</p>
            <br />
            <div class="publish-link-container mb-3 mb-sm-0">
              <router-link to="/creators/apply" class="btn btn-default">
               Apply
              </router-link>
            </div>
          </div>
       ...
       <div class="row">
         ...
         <div class="col-md-6">
              ...
              <div v-if="paused && !playing" class="video-button play">
                <button v-if="paused && !playing"  @click="play"><i class="fas fa-play video-controls"></i>  <p>Watch Video</p></button>
    ...
    <div class="copyright text-center mt-13">
      ...
      <p class="title"><b>bloverse</b><span class="sub-text">2018. All Right Reserved</span></p>
    </div>
  </main>
</template>
...
@import './CreatorLandingPage.scss';
</style>
