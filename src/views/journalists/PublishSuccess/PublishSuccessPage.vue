...
export default {
  components: {
    SuccessAlert, SocialTags, Button
  },
  data(){
    return {
      socialShare: false,
      reloadIcons: false,
      newsocialLinks:[
        "<i class='fab fa-facebook-square blue'></i><p>Facebook</p>",
        "<i class='fab fa-twitter sky'></i><p>Twitter</p>",
        "<i class='fab fa-linkedin din'></i><p>LinkedIn</p>"
      ]
