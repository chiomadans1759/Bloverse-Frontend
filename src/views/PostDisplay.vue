<template>
  <div id="postdisplaycontainer">
    <div class="main-feed">
      <router-link v-if="isLoggedIn" :to="`/journalist/${auth.loggedInUser.userName}/posts`">
        <Icon type="ios-arrow-round-back"/>Back to Dashboard
      </router-link>
      ...
      <social-sharing
        :url="url"
        :title="general.currentPost.title"
        :quote="general.currentPost.body"
        :description="general.currentPost.body"
        :media="general.currentPost.image_url"
        hashtags="bloverse"
        inline-template
      >
        <div class="share-links">
          <ion-icon name="heart-empty" style="font-size: 40px;"></ion-icon>
