<template>
  ...
  >
    <div class="d-none d-sm-block" :class="['row mx-0', { 'flex-row-reverse': listView }]">
      <div :class="[{ 'col-4 bl-postcard-image-list': listView, 'col-12 bl-postcard-image': !listView, }]"
      ...
      <div :class="['card-body', { 'col-8 py-0': listView }]">
          ...
          <div :class="['row m-0 text-capitalize actions', { 'd-none': listView }]">
            ...
            <p v-if="!hideMainActions && !showKeypoints" @click="toggleKeypoints"
              class="col-4 p-0 text-right text-capitalize keypoints"
            >
              show keypoints
            </p>
            <p v-if="!hideMainActions && showKeypoints" @click="toggleKeypoints"
            ...
            <p v-if="hideMainActions && !showKeypoints" @click="toggleKeypoints" 
              class="col-12 mt-2 p-0 text-capitalize keypoints"
            >
              show keypoints
            </p>
            <p v-if="hideMainActions && showKeypoints" @click="toggleKeypoints"
      ...
      <div class="d-none d-sm-flex" v-if="!hideMainActions"
        :class="['row px-0 border bg-white card-footer border-bottom-0 border-left-0 border-right-0 border-top',
        { 'mt-1': listView }]"
      >
