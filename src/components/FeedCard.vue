        ...
        <div class="card-body">
          <h5 class="card-titlee">{{ category }}</h5>
            ...
            <div class="foott">
              ...
              <span class="detailss">{{post.author.first_name}} {{post.author.last_name}}  <p>{{post.published | customizedTime}}</p></span>
              </div>
              <h6 class="right"><i class="fal fa-eye" style="opacity:0.4;"></i> {{post.views}}</h6>
            </div>
         </div>
          <div class="overlay">
            <p>{{post.title}}</p>
        ...
        <div class="card-body">
          ...
          <div class="overlay">
            ...
            <p class="read-more">
              ...
              <h4 class="empty-class" v-if="!post.keypoint[0] && !post.keypoint[1] && !post.keypoint[2]">
